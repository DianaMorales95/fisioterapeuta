...
export default function TestimonialCard({ text, name }: TestimonialCardProps) {
    return (
        <div className="hover:bg-gray-50 flex flex-col bg-white shadow-lg  rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
            <div className="p-4 md:p-7">
                <svg className=" size-12 text-blue-light" width="12" height="12" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
